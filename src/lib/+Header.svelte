...
<div class="flex w-full justify-center px-4 sm:px-6 lg:px-8">
	<nav
		class="nav-container fixed top-5 font-inter z-20 w-full flex h-[60px] items-center justify-between rounded-full border border-[#FFFFFF]/10 px-3 py-3  backdrop-blur-md  sm:px-4"
	>
		<!-- Logo Section -->
		<div class="flex items-center">
			...
			>
				<a href="/" class="flex items-center rounded-2xl px-3 py-2 text-white sm:px-4">
					<img src={logo2} alt="Logo" class="mr-2 h-4 w-4 flex-shrink-0" />
			...
			<div class="ml-6 hidden items-center gap-1 xl:flex xl:gap-2">
				...
				<a href="/faqs" class="nav-link">
					<button class="nav-button">FAQs</button>
				</a>
			</div>
		</div>
		...
		<div class="flex items-center gap-2">
			...
			<div class="hidden items-center gap-1 lg:flex">
				...
				<a href="/server" class=" hidden bg-border rounded-full py-1 w-full px-2 lg:block">
					<button class=" flex items-center gap-2 ">
						<img src="/beli.svg" alt="Servers" class="h-4 w-4 flex-shrink-0" />
