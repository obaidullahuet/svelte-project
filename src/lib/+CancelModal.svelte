				...
				>
					{#if option.key !== '5' && option.key !== '6'}
						...
						<div class="flex items-center gap-2">
							...
							<span class="text-[10px] sm:text-[14px] leading-1 text-[#a2a0a0]">{option.description}

								<span class="text-[10px] sm:text-[14px] leading-1 text-[#EEEDEE] underline">{option.ul}</span>
							</span>
						</div>
					{:else}
