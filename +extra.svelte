...
<div class=" flex flex-col gap-16 font-inter">
	<div class="relative h-[420px] w-full overflow-hidden">
		...
		>
			...
			<p
				class="mt-3 sm:mt-4 max-w-md sm:max-w-lg md:max-w-2xl md:px-[62px] font-inter  text-[15px] xl:text-[18px] sm:text-sm md:text-base leading-2 font-normal text-[rgba(238,237,238,0.87)]"
			>
			...
			<div class="mt-5 sm:mt-6 flex flex-col sm:flex-row justify-center gap-4 sm:gap-4">
				<button
					class="bg-border text-[#FFFFFF] font-medium py-[12px] font-inter sm:py-[14px] px-5 sm:px-6 leading-1 rounded-full text-sm sm:text-[16px] "
				>
					See What’s New
				</button>
				<button
					class="bg-[#FFFFFF] text-[#000000] font-medium py-[12px] font-inter sm:py-[14px] px-5 sm:px-6 leading-1 border border-[#FFFFFF4D] rounded-full text-sm sm:text-[16px]"
				>
		...
		<div class="grid grid-cols-1 lg:grid-cols-2 gap-3">
			...
			>
				...
				<div class="py-4 px-4 md:px-6 pr-[58px]">
					<p class="text-xs sm:text-sm md:text-base lg:text-[18px] font-normal left-1 mt-2">June 13, 2025</p>
					<p
